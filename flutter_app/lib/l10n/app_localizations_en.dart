...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get libraryDetailsEmpty => 'Select a photo to see its details';

  @override
  String get libraryTagsLabel => 'Tags';

  @override
  String get libraryNoTags => 'No tags';
  ...
  String libraryHiddenByRawOnly(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count photos in this album are hidden because \"RAW files only\" is on',
      one: '1 photo in this album is hidden because \"RAW files only\" is on',
    );
    return '$_temp0';
  }

  @override
  String get libraryShowAllFormats => 'Show all formats';
  ...
  String libraryUnsupportedFiles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count files in this album are in formats this app cannot open',
      one: '1 file in this album is in a format this app cannot open',
    );
    return '$_temp0';
  }
  ...
  @override
  String get negativeDialogTitle => 'Negative conversion';

  @override
  String get negativeColorTimingLabel => 'Colour timing';

  @override
  String get negativeRedLabel => 'Red (cyan)';

  @override
  String get negativeGreenLabel => 'Green (magenta)';

  @override
  String get negativeBlueLabel => 'Blue (yellow)';

  @override
  String get negativePrintGradeLabel => 'Print grade';

  @override
  String get negativeExposureLabel => 'Exposure';

  @override
  String get negativeContrastLabel => 'Contrast (grade)';
  ...
  @override
  String get negativeOriginalLabel => 'Original negative';

  @override
  String get negativePreviewUnavailable => 'No preview for this photo yet.';

  @override
  String get negativeConvertButton => 'Convert & save';

  @override
  String negativeConvertAllButton(int count) {
    return 'Convert & save all ($count)';
  }
  ...
  String negativeSavedMessage(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Saved $count positives',
      one: 'Saved 1 positive',
    );
    return '$_temp0 beside the originals (_Positive.tiff).';
  }
  ...
  String libraryMovingPhotos(int done, int total) {
    return 'Moving photos... ($done/$total)';
  }
  ...
  @override
  String get removeButton => 'Remove objects';
  ...
  @override
  String get removePanelTitle => 'Remove objects';
  ...
  @override
  String get removeRunButton => 'Remove';
  ...
  @override
  String get removeRunningMessage => 'Removing…';

  @override
  String removeRunningProgress(int done, int total) {
    return 'Removing… ($done/$total)';
  }
  ...
  @override
  String get removeAutoRepairLabel => 'Magical repair';
  ...
  @override
  String get removeAutoRepairSensitivity => 'Sensitivity';

  @override
  String get removeAutoRepairButton => 'Find and repair';
  ...
  String removeAutoRepairName(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Magical repair ($count spots)',
      one: 'Magical repair (1 spot)',
    );
    return '$_temp0';
  }
  ...
  String removeAutoRepairDoneMessage(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count blemishes repaired.',
      one: '1 blemish repaired.',
    );
    return '$_temp0';
  }
  ...
  String removeCountLabel(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count removals applied',
      one: '1 removal applied',
    );
    return '$_temp0';
  }
  ...
  @override
  String get maskImageLayer => 'Original Image';
