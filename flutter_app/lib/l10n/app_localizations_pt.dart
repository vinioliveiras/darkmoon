...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get libraryDetailsSection => 'DETALHES';

  @override
  String get libraryDetailsEmpty => 'Selecione uma foto para ver os detalhes';

  @override
  String get libraryTagsLabel => 'Tags';

  @override
  String get libraryNoTags => 'Sem tags';
  ...
  String libraryHiddenByRawOnly(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count fotos deste álbum estão ocultas porque \"Somente arquivos RAW\" está marcado',
      one:
          '1 foto deste álbum está oculta porque \"Somente arquivos RAW\" está marcado',
    );
    return '$_temp0';
  }

  @override
  String get libraryShowAllFormats => 'Mostrar todos os formatos';
  ...
  String libraryUnsupportedFiles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count arquivos deste álbum estão em formatos que este app não abre',
      one: '1 arquivo deste álbum está num formato que este app não abre',
    );
    return '$_temp0';
  }

  @override
  String get sidebarNewAlbumAction => 'Novo álbum aqui…';

  @override
  String get sidebarDeleteAlbumAction => 'Excluir álbum…';

  @override
  String get libraryDeleteAlbumConfirmTitle => 'Excluir álbum?';

  @override
  String libraryDeleteAlbumConfirmMessage(String name) {
    return 'Isso envia o álbum \"$name\" e tudo dentro dele para a Lixeira, e apaga as edições salvas das fotos dele.';
  }

  @override
  String get libraryBackFolderTooltip => 'Voltar ao álbum anterior';

  @override
  String get menuLibrary => 'Biblioteca';

  @override
  String get libraryBackTooltip => 'Voltar ao editor';

  @override
  String get librarySearchHint => 'Buscar por nome de arquivo';

  @override
  String libraryMinRatingTooltip(int stars) {
    return 'Mostrar fotos com $stars estrelas ou mais';
  }

  @override
  String get libraryAllLabelsTooltip => 'Todas as etiquetas';
  ...
  String get libraryEmptyFolders =>
      'Adicione uma pasta à biblioteca para navegar por ela aqui';

  @override
  String get libraryAddFolder => 'Adicionar pasta';

  @override
  String get libraryEmpty => 'Nenhuma foto nesta pasta';

  @override
  String get libraryNoMatches => 'Nenhuma foto corresponde aos filtros';
  ...
  String libraryMovingPhotos(int done, int total) {
    return 'Movendo fotos... ($done/$total)';
  }
  ...
  @override
  String get aboutThirdPartyLicenses => 'Licenças de terceiros';
  ...
  @override
  String get removeAutoRepairLabel => 'Reparo mágico';

  @override
  String get removeAutoRepairHint =>
      'Encontra sozinho pontos de poeira e riscos finos e os preenche.';

  @override
  String get removeAutoRepairSensitivity => 'Sensibilidade';

  @override
  String get removeAutoRepairButton => 'Encontrar e reparar';
  ...
  String removeAutoRepairName(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Reparo mágico ($count pontos)',
      one: 'Reparo mágico (1 ponto)',
    );
    return '$_temp0';
  }
  ...
  String get removeAutoRepairNoneMessage =>
      'Nenhuma mancha encontrada com esta sensibilidade.';
  ...
  String removeAutoRepairDoneMessage(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count manchas reparadas.',
      one: '1 mancha reparada.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get aiDenoiseEnhanceDetailSharpenLabel => 'Nitidez do detalhe';
  ...
  @override
  String get aiDenoiseEnhanceStageColorize => 'Colorindo';
  ...
  @override
  String get settingsPreviewResolutionNative => 'Nativa';
  ...
  @override
  String get settingsEditEmbeddedJpegLabel => 'Editar o JPEG da câmera';

  @override
  String get settingsEditEmbeddedJpegHint =>
      'Edita um RAW usando a renderização JPEG da própria câmera em vez dos dados do sensor. Abre mais rápido e já parte do visual que a câmera quis, mas uma imagem renderizada em 8 bits tem bem menos margem pra recuperar um céu estourado ou uma sombra fechada.';
  ...
  String get settingsRemoveSidecarsButton =>
      'Remover os arquivos .xmp que este app gravou';

  @override
  String get confirmRemoveSidecarsMessage =>
      'Isso apaga todo sidecar .xmp que o darkmoon gravou ao lado das fotos nas pastas da biblioteca. Sidecars de outros aplicativos são mantidos. Suas edições continuam no catálogo.';
  ...
  String removeSidecarsResultMessage(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count sidecars removidos',
      one: '1 sidecar removido',
      zero: 'Nenhum sidecar do darkmoon encontrado',
    );
    return '$_temp0';
  }
  ...
  @override
  String get filmImportTooltip => 'Importar LUTs (.cube, imagem Hald CLUT)';

  @override
  String get filmImportDialogTitle => 'Importar LUTs';
  ...
  String filmImportedMessage(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count LUTs importadas',
      one: '1 LUT importada',
    );
    return '$_temp0 para a lista de filmes.';
  }

  @override
  String filmImportFailedMessage(String name, String error) {
    return 'Não foi possível importar $name: $error';
  }
  ...
  @override
  String get maskImageLayer => 'Imagem Original';
  ...
  @override
  String get colorProfileModeDefault => 'Padrão';
  ...
  @override
  String get sliderClarityShadows => 'Clareza: Sombras';

  @override
  String get sliderClarityMidtones => 'Clareza: Meios-tons';

  @override
  String get sliderClarityHighlights => 'Clareza: Altas-luzes';
  ...
  @override
  String get settingsPresetThumbnailsLabel => 'Previa dos presets';

  @override
  String get settingsPresetThumbnailsHint =>
      'Mostra cada preset aplicado na foto atual';
